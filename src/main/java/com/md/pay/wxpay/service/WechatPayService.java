package com.md.pay.wxpay.service;
...
import com.md.pay.wxpay.utils.MD5Util;
import com.md.pay.wxpay.utils.XMLUtil;
...
public class WechatPayService {
	...
	public String getUrlCode(SortedMap<String, String> packageParams)
		...
		HttpPost httpPost = new HttpPost(WxConfig.pay_url);
	...
	public Map<String, Object> forRefund(SortedMap<String, String> packageParams) throws KeyStoreException, IOException,
		...
		String P12_PASSWORD = WxConfig.mch_id;
		...
		HttpPost httpPost = new HttpPost(WxConfig.refund_url);
