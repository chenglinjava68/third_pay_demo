package com.md.pay.unionpay.controller;

import com.md.pay.unionpay.sdk.SDKConstants;
...
public class BaseController {
    ...
    public static String frontUrl = "http://mr.51vip.biz:25136/pc/frontRcvResponse" ;

    // 后台服务对应的写法参照 BackRcvResponse.java
    public static String backUrl = "http://mr.51vip.biz:25136/pc/frontRcvResponse" ;// 受理方和发卡方自选填写的域[O]--后台通知地址
    ...
    public static List<Map<Integer, String>> parseZMFile(String filePath) {
        int lengthArray[] = {3, 11, 11, 6, 10, 19, 12, 4, 2, 21, 2, 32, 2, 6, 10, 13, 13, 4, 15, 2, 2, 6, 2, 4, 32, 1,
                21, 15, 1, 15, 32, 13, 13, 8, 32, 13, 13, 12, 2, 1, 131};
     ...
     *
     * @param filePath
     * @param lengthArray 参照《全渠道平台接入接口规范 第3部分 文件接口》 全渠道商户对账文件 6.1 ZM文件和6.2 ZME 文件
     *                    格式的类型长度组成int型数组
     * @return
     */
